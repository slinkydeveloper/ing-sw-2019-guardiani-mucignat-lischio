...
import com.adrenalinici.adrenaline.common.model.light.LightDashboard;
...
import static com.adrenalinici.adrenaline.common.model.CellColor.*;
import static com.adrenalinici.adrenaline.common.model.DashboardCellBoundType.DOOR;
...
public class Dashboard {
  ...
  public static class Builder {
    ...
    public Builder setDashboardChoice(DashboardChoice dashboardChoice) {
    ...
    public Dashboard build() {
      ...
      Dashboard dashboard = new Dashboard(dashboardChoice);
  ...
  private final DashboardChoice dashboardChoice;

  private Dashboard(DashboardChoice dashboardChoice) {
    this.dashboardChoice = dashboardChoice;
  }
