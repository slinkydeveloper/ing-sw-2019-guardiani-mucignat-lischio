...
public class ThorTest extends BaseGunTest {
  @Override
  ...
  @Test
  public void testBaseEffectAndChainReaction() {
    context.setTurnOfPlayer(PlayerColor.GREEN);
  ...
  @Test
  public void testWithAllEffects() {
    context.setTurnOfPlayer(PlayerColor.GREEN);
  ...
  @Test
  public void testWithOnlyHighVoltage() {
    context.setTurnOfPlayer(PlayerColor.GREEN);
    ...
    assertThat(receivedModelEvents)
      .haveExactly(1, isPlayerDashboardUpdateEvent(PlayerColor.GRAY))
      .haveExactly(0, isPlayerDashboardUpdateEvent(PlayerColor.YELLOW));
    ...
    assertThat(playerDashboard.getAmmos())
      .containsExactlyInAnyOrder(AmmoColor.RED, AmmoColor.YELLOW, AmmoColor.BLUE);
  }
}
