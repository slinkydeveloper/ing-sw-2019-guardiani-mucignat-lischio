...
public class HeatseekerGunFactory extends BaseEffectGunFactory {
  ...
  public boolean canConsume(String key, ObjectNode config) {
    return "heatseeker".equals(key);
  }

  @Override
  public List<ControllerFlowNode> getAdditionalNodes(String key, ObjectNode config) {
    return Collections.singletonList(new ApplyBaseGunFlowNode(ControllerNodes.applyGunEffect("heatseeker", "base"), APPLY));
  }
}
